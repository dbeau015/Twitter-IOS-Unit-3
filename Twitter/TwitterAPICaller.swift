...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "CVitkMHM9ftChcXZR6rfry5vf", consumerSecret: "sXItfIwmRJ4RfZnxnp7EImjs0Dt9Tvq7YGhStOGOs5ar6ZFhLd")
    var loginSuccess: (() -> ())?
